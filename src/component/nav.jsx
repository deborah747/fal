  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <Link to="/">
          <h1 className={`text-3xl font-bold ${linkColor}`}>TravelEase</h1>
        </Link>
        ...
        <div className="hidden md:flex space-x-4">
          {user ? (
            <>
              <Link to="/dashboard">
                <button className={`font-medium text-lg pt-2 ${linkColor}`}>
                  Dashboard
                </button>
              </Link>
              <button
        ...
        >
          {open ? <FiX className={`${linkColor}`} /> : <FiMenu className={`${linkColor}`} />}
        </button>
      </div>
